...
const IndiaMapChart: React.FC = () => {
  ...
  const {
    ...
    error: indiaMapError,
  } = useGetIndiaMap(shouldFetch ? indiaMapParams : null);
      ...
      <div className="bg-white border border-gray-300 rounded-lg p-6">
        ...
        <div className="flex justify-center mb-4">
          <button
            ...
            disabled={
              indiaMapLoading || parseInt(startYear) >= parseInt(endYear)
            }
          ...
          >
            {indiaMapLoading ? "Loading..." : "Generate Map"}
          </button>
        </div>
