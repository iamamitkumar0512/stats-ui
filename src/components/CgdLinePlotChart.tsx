...
const CgdLinePlotChart: React.FC = () => {
  ...
  } = useGetCgdLinePlot(shouldFetch ? cgdLinePlotParams : null);
      ...
      <div className="bg-white border border-gray-300 rounded-lg p-6">
        ...
        <div className="flex justify-center mb-4">
          <button
            ...
            disabled={
              cgdLinePlotLoading || parseInt(startYear) >= parseInt(endYear)
            }
          ...
          >
            {cgdLinePlotLoading ? "Loading..." : "Generate Chart"}
          </button>
        </div>
...
export default CgdLinePlotChart;
