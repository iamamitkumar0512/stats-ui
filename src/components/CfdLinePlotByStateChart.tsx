...
const CfdLinePlotByStateChart: React.FC = () => {
  ...
  const cfdLinePlotByStateParams = useMemo(
    ...
    [startYear, endYear, tableType, selectedState, shouldFetch]
  );
  ...
  } = useGetCfdLinePlotByState(shouldFetch ? cfdLinePlotByStateParams : null);
    ...
    <div className="w-full">
      <div className="bg-white border border-gray-300 rounded-lg p-6">
        <h2 className="text-lg font-medium text-gray-900 mb-4 text-center">
          CDF Line Plot - {selectedState} ({yearRange})
        </h2>
        ...
        <div className="flex justify-center mb-4">
          ...
          >
            {cfdLinePlotByStateLoading ? "Loading..." : "Generate State Chart"}
          </button>
        </div>
...
export default CfdLinePlotByStateChart;
